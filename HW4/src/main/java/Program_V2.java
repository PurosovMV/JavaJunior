        ...
        try (SessionFactory sessionFactory = new Configuration()
            ...
            while (option != 0) {
                ...
                try {
                    ...
                    switch (option) {
                        case 1:
                            viewTheCourses(sessionFactory.getCurrentSession());
                            break;
                        case 2:
                            addCourse(sessionFactory.getCurrentSession());
                            break;
                        case 3:
                            changeCourse(sessionFactory.getCurrentSession());
                            break;
                        case 4:
                            deleteCourse(sessionFactory.getCurrentSession());
                            break;
                        case 0:
                            exit(0);
                    }
